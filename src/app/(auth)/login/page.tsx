      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-700 bg-slate-800/50 p-8 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-slate-600 bg-slate-700/50 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-slate-700"
          >
