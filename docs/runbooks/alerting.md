...
**wcpos-com (Vercel):** `MEDUSA_API_KEY`, `DISCORD_WEBHOOK_URL`, `RESEND_API_KEY`,
`ALERT_EMAIL_TO`, `ALERT_EMAIL_FROM`, `ALERT_TEST_TOKEN`, `DOWNLOAD_TOKEN_SECRET`,
`LOKI_URL` (+`LOKI_API_KEY`), `SENTRY_DSN`, `GITHUB_APP_ID`, `GITHUB_PRIVATE_KEY`,
